...
echo "# Magnum Opus" >> /sdcard/arise_customize.prop
echo "# Generated by FreedomOS installer" >> /sdcard/arise_customize.prop
echo "install.core=true" >> /sdcard/arise_customize.prop

#if (file_getprop("/tmp/aroma/aromaroot.prop", "rootmethod") == "1")
if [[ `grep "rootmethod" /tmp/aroma/aromaroot.prop | cut -d '=' -f2` = 1 ]]; then
    echo "install.magiskcompatibility=true" >> /sdcard/arise_customize.prop
fi
